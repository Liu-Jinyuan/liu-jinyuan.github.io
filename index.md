...
[Google Scholar](https://scholar.google.com/citations?hl=en&user=JZoiqx8AAAAJ&view_op=list_works&gmla=AJsN-F6ZzJ_d96OQwlVnTF-oqgqrxpQnrrX771f60xKjQMz51DZlzs8GPt2_hGTrI5Vis-FTSqWTNqORvViWrQAw0LyK6ICOSOHpf_kRtJV1T8P-A4sOgGk), [Research Gate](https://www.researchgate.net/profile/Jinyuan-Liu-5), [ORCID](https://orcid.org/0000-0003-4133-0930), [LinkedIn](https://www.linkedin.com/in/liu-jinyuan/)  

Jinyuan is currently a Ph.D. student in Mechanical and Aerospace Engineering at the University of California San Diego, advised by Sutanu Sarkar. He received his Bachelor's Degree in Engineering Mechanics from Tsinghua University, China, in 2020. After working as a post-baccalaureate researcher at the same institute for six months, he joined [the CFD Lab](http://www.cfdlab.ucsd.edu/index.html) in January 2021. He had also been working as a pre-doctoral researcher on turbulent boundary layers at the University of Waterloo, and on turbulent channels at Universidad Politécnica de Madrid. He is generally interested in the physics and numerical simulations of canonical turbulent shear flows and geophysical flows. His current research focuses on instabilities, coherent structures, and turbulence in such flows. He seeks truth, simplicity, and beauty in fluid mechanics.  
...
**Jinyuan Liu** and Sutanu Sarkar. Scale interactions and energy transfer in the turbulent wake of a bluff body. _submitted to Journal of Fluid Mechanics_, 2026 <a target="_blank" rel="noopener noreferrer" href="https://raw.githubusercontent.com/Liu-Jinyuan/liu-jinyuan.github.io/main/docs/dwakes_scales_arxiv.pdf">(pdf)</a> [(arXiv)](http://arxiv.org/abs/2607.10028)     
**Jinyuan Liu**, Pranav Puthan, Sutanu Sarkar. Turbulence in stratified rotating topographic wakes. _Journal of Physical Oceanography_, vol. 55, no. 11, 2025 [(link)](https://journals.ametsoc.org/view/journals/phoc/aop/JPO-D-25-0035.1/JPO-D-25-0035.1.xml) [(arXiv)](https://arxiv.org/abs/2502.06129) [(data)](https://zenodo.org/records/15549518)    
...
Coherent structures in turbulence <a target="_blank" rel="noopener noreferrer" href="https://raw.githubusercontent.com/Liu-Jinyuan/liu-jinyuan.github.io/main/docs/CS_turb.pdf">(slides)</a>  
...
Computers & Programming: [command lines 101 (a,](https://hpc-training.sdsc.edu/)[ b)](https://github.com/bobbyiliev/101-linux-commands-ebook), [bash book](https://github.com/bobbyiliev/introduction-to-bash-scripting), [a short intro to LaTeX](https://mirrors.rit.edu/CTAN/info/lshort/english/lshort.pdf), [Advanced Bash Scripting Guide (ABS)](https://tldp.org/LDP/abs/html/), [a Fortran handbook (f77](http://web.stanford.edu/class/me200c/tutorial_77/)[,f90)](https://web.stanford.edu/class/me200c/tutorial_90/), [Intel Fortran developer's reference book](https://www.intel.com/content/www/us/en/docs/fortran-compiler/developer-guide-reference/2025-1/overview.html), [recursion vs loop](https://wiki.c2.com/?RecursionVsLoop), [databook (pdf, ](http://databookuw.com/databook.pdf)[ web)](http://databookuw.com), [Small PDF](https://smallpdf.com/edit-pdf),[Sumatra PDF](https://www.sumatrapdfreader.org/download-free-pdf-viewer), [dig data from figures](https://web.eecs.utk.edu/~dcostine/personal/PowerDeviceLib/DigiTest/index.html)       
Philosophies:
[good taste](http://www.paulgraham.com/goodart.html), [work hard](http://www.paulgraham.com/hwh.html), [interest](http://www.paulgraham.com/genius.html), [smart](http://www.paulgraham.com/smart.html), [do well in math](https://mathweb.ucsd.edu/~zlatos/math_classes.html), [novelty](https://medium.com/@black_51980/novelty-in-science-8f1fd1a0a143), [taste(Y)](http://www.mathchina.com/bbs/forum.php?mod=viewthread&tid=2057721), [Nicholas Carlini's blog](https://nicholas.carlini.com/writing/2026/how-to-win-a-best-paper-award.html)        
